...
class BigNatural(val dec: BigDecimal,
                 val isPositiveInfinite: Boolean = false,
                 val isNegativeInfinite: Boolean = false)
    extends ScalaNumber
    with ScalaNumericConversions
    with Serializable
    with Ordered[BigNatural] {
  ...
  def abs: BigNatural =
    new BigNatural(dec.abs, isPositiveInfinite, isNegativeInfinite)

  def apply(mc: MathContext): BigNatural =
    new BigNatural(dec(mc), isPositiveInfinite, isNegativeInfinite)
  ...
  def pow(n: Int): BigNatural =
    new BigNatural(dec.pow(n), isPositiveInfinite, isNegativeInfinite)
  ...
  def setScale(scale: Int, mode: RoundingMode): BigNatural =
    new BigNatural(dec.setScale(scale, mode),
                   isPositiveInfinite,
                   isNegativeInfinite)
  ...
  def to(end: BigNatural, step: BigNatural): Inclusive[BigDecimal] = {
    require(!isInfinite && !end.isInfinite && !step.isInfinite,
            "cannot create range from or to infinity")
    dec.to(end.dec, step.dec)
  }

  def to(end: BigNatural): Partial[BigDecimal, Inclusive[BigDecimal]] = {
    require(!isInfinite && !end.isInfinite,
            "cannot create range from or to infinity")
    dec.to(end.dec)
  }
  ...
  def ulp: BigNatural = {
    require(!isInfinite,
            "unit of last in place not defined for infinite values")
    new BigNatural(dec.ulp, false, false)
  }

  def unary_- : BigNatural =
    new BigNatural(dec.unary_-, !isPositiveInfinite, !isNegativeInfinite)
...
object BigNatural {
  def apply(dec: BigDecimal,
            isPositiveInfinite: Boolean = false,
            isNegativeInfinite: Boolean = false) =
  ...
  def min(double: Double, nat: BigNatural): BigNatural =
    BigNatural(double) min nat

  def max(double: Double, nat: BigNatural): BigNatural =
    BigNatural(double) max nat
